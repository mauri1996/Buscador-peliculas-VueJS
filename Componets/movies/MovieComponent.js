let MovieComponent ={
    ...
    filters:{
        formatId(value){
            return `movie-card-${value}`  /// filter de id para tener una id en cada pelicula
        },
        uppercase(value){
            return value.toUpperCase() // se usa el | en {{}} sin problema para q haga este metodo
        },
        formateo(value){
